    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.imageSection}>
          <Image 
            source={require("../../../assets/images/SurveyResult3.png")}
        ...
        <View style={styles.titleSection}>
          <Text style={styles.titleText}>휴식형</Text>
        </View>
        
        {/* 설명 텍스트 영역 */}
        <View style={styles.descriptionSection}>
          <Text style={styles.descriptionText}>
          여행 중에도 편안함과 여유를 우선시하는 유형입니다. 카페, 공원, 숙소 등에서 휴식을 취하거나, 심신의 안정을 도모하는 활동을 선호합니다. 때로 활동보다는 느긋하게 쉬는 것을 더 중요하게 생각합니다.
          </Text>
        </View>
