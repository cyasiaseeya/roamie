...
import EssentialAirportSvg from "../../assets/images/Survey10.svg";
...
const Survey10 = () => {
  ...
  const handleOptionPress = async (option: string) => {
    ...
    setTimeout(() => {
      return router.push('/Result' as any);
    }, 100);
  };
